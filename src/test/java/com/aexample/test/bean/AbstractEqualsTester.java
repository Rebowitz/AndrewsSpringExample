 ...
 *
 */
public class AbstractEqualsTester<T> {
 ...
 */
   ...
   *   <code>null</code>.
   */
  public static <T> AbstractEqualsTester<T> newInstance( T defaultObject ) {
    return new AbstractEqualsTester<T>( defaultObject );
  }

  private final T defaultObject;
  private boolean omitHashCodeTestsForUnequalPairs;

	private AbstractEqualsTester(T defaultObject) {
