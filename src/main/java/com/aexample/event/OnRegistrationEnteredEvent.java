...
public class OnRegistrationEnteredEvent extends ApplicationEvent {
...
//	private static @ILogger Logger logger;	
    ...
    public OnRegistrationEnteredEvent(final UserAccount user, final Locale locale, final String appUrl) {
        super(user);
        this.user = user;
        this.locale = locale;
        this.appUrl = appUrl;
