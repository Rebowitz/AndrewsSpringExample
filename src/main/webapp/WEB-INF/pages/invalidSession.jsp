...
<title>Aexample-Session Expired!</title>
...
<span style="float: right">
	<a href="?lang=en">en</a> 
		...
		<h6 style="text-align:center;">Session Expired!</h6>
		
    <div style="text-align:center; margin-top:70px;font-size:110%;"><spring:message code="message.sessionExpired"/></div>
