...
<div class="container">
		...
		<h6 style="text-align:center;">Password Updated!</h6>
		
    <div style="text-align:center; margin-top:70px;font-size:110%;"><spring:message code="message.resetPasswordSuc"/></div>
