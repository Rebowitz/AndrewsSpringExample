...
<div class="container">
		...
		<h6 style="text-align:center;">Registration Not Completed</h6>
    ...
    <div style="text-align:center; margin-top:70px;font-size:110%;"><spring:message code="message.requestResend"/></div>
 <!--  <a href="@{/login}" text="${message.login}">login</a>  -->
 
 		<div class="intro4">
			<h6>Resend Registration E-mail</h6>
			<div>
				...
				<form name='ResendRegistration' action="<c:url value='/user/resendRegistrationToken' />" method='POST'	
